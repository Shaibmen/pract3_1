...
namespace practika3_1.DataSet1TableAdapters {
...
SELECT churchID, name, address, established_date FROM Church WHERE (churchID = @churchID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::practika3_1.Properties.Settings.Default.ChurchConnectionString;
        }
...
SELECT churchServiceID, service_date, priest_id, church_id FROM ChurchService WHERE (churchServiceID = @churchServiceID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT ChurchService.churchServiceID, ChurchService.service_date, Priest.first_name, Priest.last_name, Priest.middle_name, Priest.ierarch_position, Church.name, Church.address, Church.established_date
From ChurchService
LEFT JOIN Priest ON ChurchService.priest_id = Priest.PriestID
LEFT JOIN Church ON ChurchService.church_id = Church.churchID;";
        ...
        public virtual int FillBy(DataSet1.ChurchServiceDataTable dataTable) {
        ...
        public virtual DataSet1.ChurchServiceDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet1.ChurchServiceDataTable dataTable = new DataSet1.ChurchServiceDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
